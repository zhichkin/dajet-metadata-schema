...
Такой объект формируется из ссылочных типов данных и, зависимых от него,
регистров сведений или накопления. Кодирование агрегата выполняется аналогично
кодированию табличных частей ссылочного типа данных.
```json
// Пример кодирования объекта справочника "Валюты" и,
// связанного с ним, значения регистра сведений "КурсыВалют".
{
   "Ссылка": "26093579-c180-11e4-a7a9-000d884fd00d",
   "Код": "840",
